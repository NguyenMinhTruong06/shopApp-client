...
public class SearchProductListAdapter extends RecyclerView.Adapter<SearchProductListAdapter.SearchProductListAdapterViewHolder>{
        ...
        @NonNull
        @Override
        public SearchProductListAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_product_list, parent, false);
            return new SearchProductListAdapterViewHolder(view);
        }

    @Override
    public void onBindViewHolder(@NonNull SearchProductListAdapterViewHolder holder, int position) {
        ...
        public static class SearchProductListAdapterViewHolder extends RecyclerView.ViewHolder {
            ImageView productImage;
            TextView productName, productPrice, productDescription, productQuantity;
            ConstraintLayout itemProduct;

            public SearchProductListAdapterViewHolder(@NonNull View itemView) {
                super(itemView);
